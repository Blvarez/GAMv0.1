...
export default function RespuestaUsuario({ estadoRespuestaBloq, cambioEstadoRespuestaBloq}: Props) {
            ...
            {estadoRespuestaBloq &&
                <div className="w-screen h-screen bg-black bg-opacity-40 top-0 left-0 fixed items-center justify-center flex">
                    ...
                    <div className="modalColor bg-white w-[450px] h-[340px] relative p-2 rounded">
                        ...
                        <h1 className="text-center text-xl"><strong>Usuario o Contrasenia</strong></h1>
                        <h1 className="text-center"><strong>Incorrectas...!</strong></h1>
