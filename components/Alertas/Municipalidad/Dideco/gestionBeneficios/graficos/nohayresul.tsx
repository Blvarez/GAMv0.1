...
export default function RespuestaBsq({ estadoRespuesta, cambioEstadoRespuesta}: Props) {
            ...
            {estadoRespuesta &&
                <div className="w-screen h-screen bg-black bg-opacity-40 top-0 left-0 fixed items-center justify-center flex">
                    ...
                    <div className="modalColor bg-white w-[450px] h-[340px] relative p-2 rounded">
                        ...
                        <h1 className="mt-[10px] text-center text-xl"><strong>No se encuentran Solictudes</strong></h1>
                        <h1 className="text-center"><strong>En ese periodo de tiempo</strong></h1>
