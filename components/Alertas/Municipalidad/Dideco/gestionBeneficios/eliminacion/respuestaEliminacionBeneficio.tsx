...
export default function RespuestaEliminacion({ estadoRespuestaEliminacion, cambioEstadoRespuestaEliminacion, id, error }: Props) {
    ...
    let textoAbajo = null;
    if (errorr == 1) { // Eliminado con Exito
        textoAbajo = (
            <div className="modalColor bg-white w-[450px] h-[310px] relative p-2 rounded">
                ...
                <h1 className="mt-[10px] text-center text-xl text-[#427DA2]"><strong>Beneficio de Id: {idd}</strong></h1>
                <h1 className="text-center text-[#427DA2]"><strong>Eliminado con Exito!!...</strong></h1>
        ...
        textoAbajo = ( //No se puede eliminar
            <div className="modalColor bg-white w-[450px] h-[340px] relative p-2 rounded">
                ...
                <h1 className="mt-[10px] text-center text-xl"><strong>Beneficio de Id: {idd}</strong></h1>
                <h1 className="text-center text-xl"><strong>No se puede Eliminar</strong></h1>
                <h1 className="text-center"><strong>Tiene Solicitudes este Beneficio</strong></h1>
        ...
        textoAbajo = ( //No se puede eliminar
            <div className="modalColor bg-white w-[450px] h-[340px] relative p-2 rounded">
                ...
                <h1 className="mt-[10px] text-center text-xl"><strong>Beneficio de Id: {idd}</strong></h1>
                <h1 className="text-center text-xl"><strong>No se puede Eliminar</strong></h1>
                <h1 className="text-center"><strong>Beneficio no Existe.....</strong></h1>
                <button className="navbarColor text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline ml-[165px] mt-[20px]" onClick={cerrar} type="button">Aceptar</button>
            </div>
        )
    }
