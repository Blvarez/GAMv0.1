...
export default function RespuestaCreacionMunicipalidad({ datoExtra, tipoDato, estadoCreacion, cambioEstadoCreacion, error }: Props) {
    ...
    function erroro(numero: number) {
        if (numero == 1) {
            ...
            cambioTexto = (
                <h1 className="text-center text-[#427DA2]"><strong>Se crea solo un nuevo Admin..!</strong></h1>
            )
            return (
                <div>
                    <button className="absolute ml-[405px] mt-[-5px] text-red-500 w-[25px]" onClick={() => { cambioEstadoCreacion(false) }}><FontAwesomeIcon className="text-3xl colorX" icon={faTimes}></FontAwesomeIcon></button>
                    <h1 className="ml-[145px] mt-[-5px] w-[150px]"><FontAwesomeIcon icon={faTimesCircle} className="text-[#003352] text-9xl" /></h1>
                    <h1 className="text-center text-2xl text-[#427DA2]"><strong>Se crea solo un nuevo Admin..!</strong></h1>
                </div>
            )
        }
        return null;
    ...
    function tipoo(tipoDatoo: number, datoExtraa: any) {
        ...
        if (tipoDatoo == 3) {
            return (
                <>
                    <h1 className="mt-[10px] text-center text-xl text-[#427DA2]"><strong>Administrador de Rut: {datoExtraa}</strong></h1>
            ...
            return (
                <>
                    <h1 className="mt-[10px] text-center text-xl text-[#427DA2]"><strong>No se admite formato Rut</strong></h1>
                    <button className="navbarColor text-white bg-[#427DA2] font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline ml-[160px] mt-[3px]" onClick={() => { cambioEstadoCreacion(false) }} type="button">Aceptar</button>
                </>
            )
        }
            ...
            return (
                <>
                    <h1 className="mt-[10px] text-center text-xl text-[#427DA2]"><strong>Ya existe la Base de Datos</strong></h1>
                    <button className="navbarColor text-white bg-[#427DA2] font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline ml-[160px] mt-[3px]" onClick={() => { cambioEstadoCreacion(false) }} type="button">Aceptar</button>
                </>
            )
        }
