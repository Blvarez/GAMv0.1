...
export default function ModalSoliVerEntreA({ estadoModalSoliVerEntreA, cambioEstadoModalSoliVerEntreA, anio, id }: Props) {
    ...
    const obtenerSolicitudesEntregadas = () => {
        axios({
            ...
            url: "http://localhost:3001/dideco/solicitudes/entregasA",
            ...
            {estadoModalSoliVerEntreA &&
                ...
                <div className="z-10 w-screen h-screen bg-black bg-opacity-40 top-0 left-0 fixed items-center justify-center flex">
                    <div className="mt-[18px] modalColor bg-white w-[1000px] h-[600px] relative p-2 rounded">
                        ...
                        <button className="navbarColor text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mt-[480px] ml-[420px] w-[100px] absolute" onClick={() => cambioEstadoModalSoliVerEntreA(false)} type="button">Aceptar</button>
