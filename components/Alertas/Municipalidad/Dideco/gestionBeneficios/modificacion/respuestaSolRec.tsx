...
//@ts-ignore
export default function RespuestaSolRec({ estadoRespuestaSolRec, cambioEstadoRespuestaSolRec }: Props) {
            ...
            {estadoRespuestaSolRec &&
                <div className="w-screen h-screen bg-black bg-opacity-40 top-0 left-0 fixed items-center justify-center flex">
                    ...
                    <div className="modalColor bg-white w-[450px] h-[340px] relative p-2 rounded">
                        ...
                        <h1 className="mt-[10px] text-center text-xl"><strong>Solicitud Rechazada</strong></h1>
                        <h1 className="text-center text-xl"><strong>Con Exito ...!</strong></h1>
